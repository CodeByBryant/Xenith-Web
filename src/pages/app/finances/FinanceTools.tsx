  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      <motion.div
        ...
        className="mb-6"
      >
        <h1 className="text-xl font-semibold text-foreground">Finance Tools</h1>
        <p className="text-sm text-muted-foreground mt-1">
          Track income and expenses to strengthen your Finances dimension score.
        </p>
      </motion.div>
      ...
      >
        ...
        <motion.div variants={itemVariants}>
          <Link
            to="/app/dimensions/finances/transactions"
            className="group flex items-center gap-4 p-5 bg-card border border-border rounded-2xl hover:border-yellow-500/40 transition-all duration-200"
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Log income and expenses, see where money actually goes
              </p>
            </div>
