...
import { ChevronLeft, TrendingUp, TrendingDown, Clock, CheckCircle, AlertTriangle } from "lucide-react";
      ...
      <div className="flex-1 px-5 overflow-y-auto space-y-4">
        ...
        >
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-sm text-[#fafafa]">18 intentions completed this week</span>
          </div>
        ...
        >
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-sm text-[#fafafa]">{totalFocus.toFixed(1)}h focused this week</span>
          </div>
        ...
        >
          <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl p-3 flex items-center gap-3">
            ...
            <p className="text-sm text-[#fafafa]">You're most productive on <span className="font-medium">Thursdays</span></p>
          </div>
          <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl p-3 flex items-center gap-3">
            <Clock className="w-5 h-5 text-[#3b82f6]" />
            <p className="text-sm text-[#fafafa]">Your focus peaks between <span className="font-medium">9-11 AM</span></p>
          </div>
          <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl p-3 flex items-center gap-3">
            <AlertTriangle className="w-5 h-5 text-[#eab308]" />
            <p className="text-sm text-[#fafafa]"><span className="font-medium">Rest</span> dimension needs attention (-15%)</p>
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-[#fafafa] font-medium">Life Balance Trend</span>
